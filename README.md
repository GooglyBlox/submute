...
### Firefox Version
Mozilla without notice has deactivated my Mozilla Developer account and removed SubMute from the Mozilla Addon Store. I'll be investigating the reasoning and contacting support, but in the meantime you can download the official Firefox version via the methods below:
